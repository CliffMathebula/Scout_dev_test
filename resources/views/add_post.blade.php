...
<div class="col">
    ...
    <div class="card text-white bg-light">
        <div class="card-body">
            ...
            <form method="GET" action="{{ action('blogsController@create_post') }}">
                @csrf_token

                <div class="form-group row">
                    <label for="surname" class="col-md-4 col-form-label text-md-left text-dark">{{ __('Post Title') }}</label>
                    <div class="col-md-6">
                        <input id="post_title" type="text" class="form-control @error('Title') is-invalid @enderror" name="post_title" value="" required autocomplete="Title" autofocus>
                        @error('surname')
